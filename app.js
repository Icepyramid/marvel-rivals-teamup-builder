...
const HERO_DARK_HISTORY = {
  "Adam Warlock": "The master of cheating death built launch's \"nothing ever dies\" meta — until the balance team executed the revive meta itself. The one resurrection he couldn't perform. Or couldn't he?",
  "Angela": "Heven's mightiest warrior arrived to first-pick hype and went straight into balance purgatory — too strong for pros to ignore, too meta dependent for them to actually play. An angel of tomorrow they promised.",
  ...
  "Devil Dinosaur": "Sixty-five million years of apex predator, undone by geometry — at pro level his hitbox isn't a body, it's a range-calibration service the enemy mantis thank him for.",
  "Doctor Strange": "The Sorcerer Supreme — sworn guardian of reality's integrity — personally authored the biggest hole in the game's reality: spawn portals that fed cross-map misplaced Invisible Woman's ults. No ability in Rivals history has needed more patching than the one guarding the universe.",
  "Elsa Bloodstone": "The hunter who's prepared for every monster is balanced around coordinated trap setups that even tournament teams feared to run into. She prepared for everything, too late for enemy spidey to see.",
  ...
  "Gambit": "The master thief getting robbed by his own stat sheet all the time — nobody's hot take: Should give him Kinetic charm; zero charm with the numbers, mon ami.",
  ...
  "Hawkeye": "The archer who never misses got nerfed for never missing — launch Hawkeye's cross-map one-shots made permaban the only recognized counterplay. Ask any season-zero pro what the sound of a bowstring did to their heart rate, and perhaps someday again.",
  ...
  "Hulk": "\"The strongest there is\" owns the weakest moment in Rivals: burst down mid-ult and dropped back into little Banner in front of a full lobby. The anchor of the launch gamma meta, and the anger-management case of every meta since, until they messed up with his cooldowns.",
  ...
  "Iron Man": "The futurist never saw any of it coming: at launch, hovering in the world's most advanced suit was the fastest route into Hela's highlight reel — and a hotfix trimmed his Thor beam. A billionaire whose stock only trends down.",
  "Jeff the Land Shark": "The most adorable hero in the game committed its most infamous war crime: swallowing six players and carrying them all off the map. The nerf took days. The smile never moved. And they ask, who's world champion next?",
  "Jubilee": "Her entire identity is a celebration, and her launch numbers were the cleanup afterward. Fireworks that needed a patch to actually go off, because Luna was too OP.",
  "Loki": "The god of mischief's greatest trick was making the objective itself unplayable — copying enemy Gambit's ult. They rewrote the game's entire energy economy because of him. He would absolutely call that a win.",
  ...
  "Namor": "Dive players ban the king of Atlantis out of respect, not fear — entire professional dive compositions have drowned at his squids. First they laughed at the fish king; then they stopped first-picking Spider-Man, which had nothing to do with him nowadays.",
  "Peni Parker": "The pilot protecting the future turned defense-side spawn into a demilitarized zone — tournaments were literally played around never touching her web. Then, nest by nest, into the past she was built to prevent.",
  ...
  "Psylocke": "The scalpel of every pro dive meta — so surgically consistent the watchlist keeps her on permanent retainer. Season 9's first hotfix cut her crossbow, her illusion, and her Team-Ups in a single sitting: the assassin, finally assassinated slightly again.",
  "Rocket Raccoon": "The galaxy's greatest weapons engineer spent years memed as a conscientious objector — unkillable, untouched by patch notes, damage filed as decorative. Season 9 finally acknowledged the arsenal… by buffing his green smoking PvZ gun.",
  ...
  "Spider-Man": "A permanent fixture of low-rank ban phases while simultaneously posting some of the lowest win rates in the game — the only hero in Rivals who is feared and statistically harmless at the same time. With great power came no correlation whatsoever.",
  "Squirrel Girl": "Canonically undefeated — she's beaten Thanos and Galactus. Competitively, her ricochet artillery checks map geometry harder than it checks uncle Sam, making the unbeatable one the most comfortably beaten pick in tournament history.",
  "Star-Lord": "His ultimate is a literal aimbot, balanced for years by the rest of his kit being a rumor — a legendary outlaw whose bounty the pro scene never bothered to miss.",
  "Storm": "The weather goddess launched unable to outrun weather — consensus worst duelist, a slow-floating training dummy. One rework later she's a hurricane that has never left the forecast.",
  ...
  "Winter Soldier": "AGAIN. AGAIN. AGAIN. The ult-reset chains produced the most demoralizing kill feed in competitive Rivals — a man with a metal arm and infinite encores. Nerfed, never forgotten.",
