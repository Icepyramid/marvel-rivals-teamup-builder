...
// One "dark history" fun fact per hero — their real performance rap sheet
// in Marvel Rivals, written to maximize IRONY: each hero's own identity
// turned against their competitive record, framed at a high-rank/pro-play
// level (ban rates, scrim metas, ult economy) — never low-elo complaining.
// Deliberately no mention of loop mechanics here.
const HERO_DARK_HISTORY = {
  "Adam Warlock": "The master of cheating death built launch's \"nothing ever dies\" meta — until the balance team executed the revive meta itself. The one resurrection he couldn't perform.",
  "Angela": "Heven's mightiest warrior arrived to first-pick hype and went straight into balance purgatory — too strong for pros to ignore, too clunky for them to actually play. An angel stuck in review queue.",
  "Black Cat": "Her entire kit is built on luck, and the stat sheet took that personally — no hero's win rate has flipped harder patch to patch. The bad luck she inflicts on others started at home.",
  "Black Panther": "The king who never dies in lore dies in scrims to a single missed Vibranium Mark — the most technically perfect duelist in the game, and the one most completely erased by one frame of imperfection.",
  "Black Widow": "The world's deadliest assassin spent seasons as the game's least lethal hero — pro lobbies read a Widow lock as a forfeit notice. The master of espionage was the one thing the stats could always find.",
  "Blade": "The Daywalker who hunts things that never die spent longer than anyone trapped in cinematic teasers — and when he finally arrived, the first thing the balance team did was drain his lifesteal. The vampire hunter, bled by patch notes.",
  "Captain America": "\"I can do this all day\" was the problem: at launch, pros timed that all day genuinely wasn't long enough for Cap to kill one Strategist. Buff after buff later, the man who couldn't finish a fight is the dive every pro backline plans around.",
  "Cloak & Dagger": "Two heroes about the balance of light and dark who have never once been balanced — and for whole competitive seasons, the professional answer to both of them was the same: pick Luna instead.",
  "Cyclops": "The man famous for never missing opened Season 9 with numbers so short of the mark that the first emergency hotfix handed his optic blasts their damage back. The visionary leader did not see it coming.",
  "Daredevil": "The blind man reads the map better than anyone with working eyes — his wall-sense is so clean that high-elo players describe fighting him as a wallhack with a law degree. Justice is blind; his crosshair isn't.",
  "Deadpool": "The unkillable hero is the balance team's most-killed spreadsheet: he refuses to commit to a role, so every number in his kit exists in triplicate. He knows there's a patch-note section about him. He's proud of it.",
  "Devil Dinosaur": "Sixty-five million years of apex predator, undone by geometry — at pro level his hitbox isn't a body, it's a range-calibration service the enemy hitscans thank him for.",
  "Doctor Strange": "The Sorcerer Supreme — sworn guardian of reality's integrity — personally authored the biggest hole in the game's reality: spawn portals that fed cross-map Hela executions. No ability in Rivals history has needed more patching than the one guarding the universe.",
  "Elsa Bloodstone": "The hunter who's prepared for every monster is balanced around coordinated trap setups that even tournament teams rarely bother to run. She prepared for everything except being optional.",
  "Emma Frost": "The telepath was the one hero nobody needed telepathy to figure out — every pro lobby said \"she's overtuned\" out loud for two straight seasons, and she stayed in every lineup anyway. Diamond, after all, resists pressure.",
  "Gambit": "The master thief opened Season 9 getting robbed by his own stat sheet — the first emergency hotfix had to hand him three separate buffs. Kinetic charm; zero charm with the numbers, mon ami.",
  "Groot": "More pro ults have died into a friendly Groot wall than into any enemy shield — the roster's designated protector is, by the numbers, the single largest tax on his own team's ult economy. He is Groot. He is sorry.",
  "Hawkeye": "The archer who never misses got nerfed for never missing — launch Hawkeye's cross-map one-shots made permaban the only recognized counterplay. Ask any season-zero pro what the sound of a bowstring did to their heart rate.",
  "Hela": "The goddess of death was the one thing early Rivals could not kill — banned in effectively every lobby allowed to ban her, nerfed novella-thick, and still running four Team-Ups like the family business never closed. Death, officially overtuned.",
  "Hulk": "\"The strongest there is\" owns the weakest moment in Rivals: burst down mid-ult and dropped back into little Banner in front of a full lobby. The anchor of the launch gamma meta, and the anger-management case of every meta since.",
  "Human Torch": "Flame on, flamed out — the moment organized teams remembered to aim upward, sustained hitscan extinguished him. His hottest competitive tech is lighting Storm's hurricane, which is why the watchlist files him under \"Storm accessory\".",
  "Invisible Woman": "Launched so strong that \"focus the healer\" became a trust exercise — you cannot focus what you cannot see. The most visible hero in every overtime stall of her era was the invisible one.",
  "Iron Fist": "The Immortal Iron Fist has died exactly once: to a patch. Pros never rated him, the ladder never forgave him, and the nerf came for the tears anyway — immortality, meditated into irrelevance.",
  "Iron Man": "The futurist never saw any of it coming: at launch, hovering in the world's most advanced suit was the fastest route into Hela's highlight reel — and this very hotfix trimmed his Thor beam. A billionaire whose stock only trends down.",
  "Jeff the Land Shark": "The most adorable hero in the game committed its most infamous war crime: swallowing six players and carrying them all off the map. The nerf took days. The smile never moved.",
  "Jubilee": "Her entire identity is a celebration, and her launch numbers were the cleanup afterward — buffed in Season 9's first emergency hotfix. Fireworks that needed a patch to actually go off.",
  "Loki": "The god of mischief's greatest trick was making the objective itself unplayable — copying Luna's ult for twenty straight seconds of concert. They rewrote the game's entire energy economy because of him. He would absolutely call that a win.",
  "Luna Snow": "Her concerts were so good that, for a while, nobody was allowed to die during them — literally. Games at the highest level came down to whose immortality playlist ran longer. The encore got nerfed; the tour, somehow, continues.",
  "Magik": "The ruler of Limbo launched stuck in it — mid, ignored, benched. Then the buffs opened a portal, Darkchild started stat-checking Vanguards, and \"nerf Magik\" became recurring pro-scrim small talk. She didn't leave Limbo; she relocated the meta there.",
  "Magneto": "Author of the greatest single play in Rivals history — eating a full Punisher ult and returning it as a one-shot meatball — and of a thousand self-detonations from holding that same sphere one second too long. The master of attraction, fatally attracted to greed.",
  "Mantis": "The empath launched as arguably the best hero in the game — a healer out-damaging duelists. She has felt every wave of nerfs since, including another healing cut in Season 9's first hotfix. She senses everyone's pain; the patch notes make sure she shares it.",
  "Mister Fantastic": "The smartest man alive keeps acing the wrong exam: world-class at inflating to eat a full enemy ult, seasonally absent from pro lineups anyway. Infinitely flexible; rigidly benched.",
  "Moon Knight": "Khonshu's justice once deleted six stacked players before the voice line finished — the fastest team wipe ever recorded in Rivals. It was nerfed into a slower, more bureaucratic team wipe. The moon's judgment now arrives by appointment.",
  "Namor": "Dive players ban the king of Atlantis out of respect, not fear — entire professional dive compositions have drowned at his squids. First they laughed at the fish king; then they stopped first-picking Spider-Man.",
  "Peni Parker": "The pilot protecting the future turned defense-side spawn into a demilitarized zone — tournaments were literally played around never touching her web. Then the patches dragged her out of it, nest by nest, into the past she was built to prevent.",
  "Phoenix": "The literal cosmic embodiment of death and rebirth launched into Season 9 dead on arrival — and was hotfixed back to life within the week. The Phoenix Force's most consistent resurrection is the balance team.",
  "Psylocke": "The scalpel of every pro dive meta — so surgically consistent the watchlist keeps her on permanent retainer. Season 9's first hotfix cut her crossbow, her illusion, and her Team-Ups in a single sitting: the assassin, finally assassinated.",
  "Rocket Raccoon": "The galaxy's greatest weapons engineer spent years memed as a conscientious objector — unkillable, untouched by patch notes, damage filed as decorative. Season 9 finally acknowledged the arsenal… by buffing his acorns.",
  "Rogue": "Her whole power is taking everyone else's — which makes her a permanent balance incident, because every buff anywhere on the roster is secretly also a Rogue buff. The patch notes' only recurring stowaway.",
  "Scarlet Witch": "Wields enough chaos magic to rewrite reality; never managed to rewrite a pro pick rate. And her ult announces itself so loudly that at the top level it functions less as an ultimate and more as a fire drill.",
  "Spider-Man": "A permanent fixture of high-rank ban phases while simultaneously posting some of the lowest win rates in the game — the only hero in Rivals who is feared and statistically harmless at the same time. With great power came no correlation whatsoever.",
  "Squirrel Girl": "Canonically undefeated — she's beaten Thanos and Galactus. Competitively, her ricochet artillery checks map geometry harder than it checks pros, making the unbeatable one the most comfortably beaten pick in tournament history.",
  "Star-Lord": "His ultimate is a literal aimbot, balanced for years by the rest of his kit being a rumor — a legendary outlaw whose bounty the pro scene never once bothered to collect.",
  "Storm": "The weather goddess launched unable to outrun weather — consensus worst duelist, a slow-floating training dummy. One rework later she's a permaban hurricane that has never left the forecast. From bottom-one to ban-one: the only forecast that never changes.",
  "The Hood": "He traded his soul for power, and the power still fluctuates by patch — one cycle his veils choke tournaments, the next his gun is a water pistol. Somewhere, a demon is very pleased with the fine print.",
  "The Punisher": "A one-man army that pro teams used as a diagnostic tool: if the Punisher is free-firing, someone's shield discipline has died. All that punishment, entirely dependent on the other five people showing up.",
  "The Thing": "Ever tried, ever unstoppable, never in range — launched as a clobbering statue whose entire matchup chart reduced to \"does the enemy feel like walking over?\". It's clobberin' time remains, at the highest level, unscheduled.",
  "Thor": "The god of thunder spent his early seasons as a Thorforce spreadsheet with mid output — and keeps getting dragged back into the meta by other heroes' Team-Ups instead of his own hammer. Worthy of Mjolnir; carried by the roster.",
  "Ultron": "The AI plotting humanity's obsolescence was out-planned by a hotfix in week one of Season 9 — drone healing halved, cooldown stretched. The machines learn. The balance team learns faster.",
  "Venom": "The most instalocked Vanguard in Rivals is also its biggest variance bet — the same hero is a zero-final-blow feeding montage or an unkillable playmaker depending entirely on the brain wearing him. The symbiote is only as good as its host; the stats have always agreed.",
  "White Fox": "A nine-tailed guardian spirit whose early pricing put roughly seven of the tails at cosmetic — her Fox Form windows have been re-cut nearly every patch since release. Still auditioning for her own kit.",
  "Winter Soldier": "AGAIN. AGAIN. AGAIN. The ult-reset chains produced the most demoralizing kill feed in competitive Rivals — a man with a metal arm and infinite encores. Nerfed, never forgotten; pros still flinch at the voice line.",
  "Wolverine": "\"The best there is at what he does\" launched with the lowest pick rate and win rate in the game — what he did, briefly, was nothing. Then someone ran the percent-HP math, and he became the most banned tank-shredder in pro play. The healing factor eventually applied to his win rate."
};
...
function undo() {
  // The Ignite simulator owns the board while active — walking the normal
  // undo timeline underneath it would desync the draft from the display.
  if (igniteOn) return;
...
function addNode(hero, x, y, options = {}) {
  ...
  el.addEventListener("contextmenu", event => {
    ...
    // During an Ignite draft the board layout is owned by the simulator —
    // right-click removal would silently corrupt the draft picture.
    if (igniteOn) return;
...
// Official Ignite ban & lock process (Tournament Advanced — verbatim from
...
const IGNITE_SEQUENCE = [
  ...
  { team: "B", kind: "lock" }, { team: "A", kind: "lock" },
  { team: "A", kind: "ban" }, { team: "B", kind: "ban" },
  { team: "B", kind: "lock" }, { team: "A", kind: "lock" },
  { team: "A", kind: "ban" }, { team: "B", kind: "ban" }
];
...
function igniteBans() {
  ...
  IGNITE_SEQUENCE.forEach((step, i) => {
    ...
    if (step.kind === "ban" && hero && hero !== IGNITE_SKIPPED) banned.add(hero);
  });
  return banned;
}

function igniteLocks(team) {
  const locked = new Set();
  IGNITE_SEQUENCE.forEach((step, i) => {
    const hero = ignite.steps[i];
    if (step.kind === "lock" && step.team === team && hero && hero !== IGNITE_SKIPPED) locked.add(hero);
  });
  return locked;
}

function igniteUsedHeroes() {
...
function igniteAssign(hero) {
  ...
  if (stepIndex !== -1) {
    if (igniteDraftPaused) return false; // inspecting, not drafting
    const step = IGNITE_SEQUENCE[stepIndex];
    if (igniteUsedHeroes().has(hero)) {
      igniteNotice(`${hero} is already part of this draft.`);
      return true;
    }
    if (step.kind === "ban" && igniteLockedBy(hero)) {
      igniteNotice(`${hero} is locked by Team ${igniteLockedBy(hero)} — locked heroes cannot be banned.`);
      return true;
    }
  ...
  if (igniteArming) {
    const { team, index } = igniteArming;
    if (igniteBans().has(hero)) {
      igniteNotice(`${hero} is banned from this match — nobody can pick them.`);
      return true;
    }
    if (ignite[`comp${team}`].includes(hero)) {
      igniteNotice(`${hero} is already in Team ${team}'s comp.`);
      return true;
    }
...
function igniteSkipStep() {
  const stepIndex = igniteStepIndex();
  if (stepIndex === -1) return;
  ignite.steps[stepIndex] = IGNITE_SKIPPED;
  igniteNoticeText = "";
  saveIgnite();
  renderIgnite();
}
...
function igniteResetDraft() {
  ignite.steps = Array(IGNITE_SEQUENCE.length).fill(null);
  ignite.compA = Array(6).fill(null);
...
function renderIgnite() {
  ...
  IGNITE_SEQUENCE.forEach((step, i) => {
    ...
    chip.className = `ignite-step team-${step.team.toLowerCase()} ${step.kind}`
      + (i === stepIndex ? " current" : "")
      + (ignite.steps[i] ? " done" : "");
    const hero = ignite.steps[i];
  ...
  // Current-step prompt.
  const current = document.querySelector("#igniteCurrent");
  if (stepIndex !== -1) {
    const step = IGNITE_SEQUENCE[stepIndex];
    current.innerHTML = igniteDraftPaused
  ...
  if (stepIndex === -1) {
    for (const team of ["A", "B"]) {
      ...
      row.className = `ignite-comp-row team-${team.toLowerCase()}`;
      const label = document.createElement("span");
  ...
  // Factual impact only — no draft advice (pros draft on meta, not counts).
  const impact = document.querySelector("#igniteImpact");
  impact.innerHTML = "";
  if (igniteNoticeText) {
    const notice = document.createElement("p");
    notice.className = "ignite-notice";
    notice.textContent = igniteNoticeText;
    impact.append(notice);
  }
  ...
  if (banned.size) {
    ...
    if (dry.length) {
      ...
      dryLine.innerHTML = `<strong>Left with zero Team-Up options:</strong> ${dry.join(", ")} — still pickable, but every hero who could enhance them is banned.`;
      impact.append(dryLine);
    }
  }
}
...
document.querySelector("#igniteSkip").addEventListener("click", igniteSkipStep);
document.querySelector("#igniteUndo").addEventListener("click", igniteUndoStep);
document.querySelector("#igniteReset").addEventListener("click", igniteResetDraft);
...
function revertTransientViews() {
  // The Ignite simulator's split draft board is transient too — restore
  // the real board before any board-level persistence can capture it.
  if (igniteOn) setBottomMode("comp");
  if (compOnlyViewOn) {
    restoreState(compOnlyViewSnapshot);
    compOnlyViewOn = false;
    compOnlyViewSnapshot = null;
